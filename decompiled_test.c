...

{
  ...
  __libc_start_main(FUN_0010117b,in_stack_00000000,&stack0x00000008,&LAB_001011d0,&DAT_00101230,
                    param_3,auStack8);
  do {
...
ulong FUN_00101135(int param_1,int param_2)
...
ulong FUN_00101148(long param_1)
...

{
  ...
  local_10 = 2;
  local_c = 3;
  uVar1 = FUN_00101148(&local_14);
  FUN_00101135((ulong)local_14,(ulong)uVar1,(ulong)uVar1);
  FUN_00101159();
  return (ulong)DAT_00104030;
}
